...
public class StatPrinter 
{
	...
	int size = _frequency.size();
	for(int i = 0; i < size; i++){
	    System.out.print(i + ": ");
	    int temp = _frequency.get(i);
	    for(int n = (int) (longestBar * (1.0*temp/maxVal)); n > 0; n--){
		System.out.print("*");
	    }
	    System.out.println();
	}       
	...
	test.add(2);
	test.add(4);
	StatPrinter name = new StatPrinter(test);
	System.out.println(name._frequency);
	System.out.println(name.getLocalModes());
	name.printHistogram(2);
    }
